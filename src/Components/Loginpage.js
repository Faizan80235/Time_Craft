  ...
  alt="Watch"
        ...
        <div className="col-md-6 bg-white d-flex align-items-center justify-content-center p-5">
          <div className="w-100" style={{ maxWidth: '400px' }}>
            ...
            <p className="text-center text-muted mb-4">Login to your TimeCraft account</p>
            ...
            <form>
              ...
              <div className="mb-4">
                ...
                <input type="password" className="form-control form-control-lg rounded-3" placeholder="••••••••" />
              </div>
